...
/* Elliot, print accounting system for Cups.
 ...
 Foundation, Inc., 51 Franklin Street, Fifth Floor, Boston, MA  02110-1301, USA. */
  ...
  $totalprinter=jas_getPrinterRankings(1000);
  
?><!-- Inicio do Sumario -->

<h2>Relatório completo das Impressoras</h2>

<?=($totalprinter)?$totalprinter:"<p>An error occured, please check the error messages.</p>"?>
